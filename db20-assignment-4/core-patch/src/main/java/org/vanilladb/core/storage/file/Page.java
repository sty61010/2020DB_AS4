...
public class Page {
	...
	/**
	 * Calculates the number of bytes required to store a {@link Constant constant}
	 * in disk.
	 * 
	 ...
	 * {@link VanillaDb#init(String)} or {@link VanillaDb#initFileMgr(String)} or
	 * {@link VanillaDb#initFileAndLogMgr(String)} is called first.
	 */
	public Page() {
	}
	...
	/**
	 * Returns the value at a specified offset of this page. If a constant was not
	 * stored at that offset, the behavior of the method is unpredictable.
	 * 
	 ...
	 * @param offset the byte offset within the page
	 * 
	 * @param val    the constant value to be written to the page
	 */
